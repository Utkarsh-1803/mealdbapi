    ...
    .then((jsonData) => {
      ...
      if (arr === null) {
        ...
        if (!list.hasChildNodes()) {
          item.innerHTML =
            '<p style = "font-size: 1.8rem">No results found...</p>';
...
document.getElementById("show-home").addEventListener("click", showHome);
...
function showHome() {
  //onCLick event on Show Home button, show homepage itself
  searchField.value = "";
  list.textContent = "";
}
